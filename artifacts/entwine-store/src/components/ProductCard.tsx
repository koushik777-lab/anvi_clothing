    ...
    >
      ...
      {product.inStock && onAddToCart && (
        <button
          ...
          className="absolute bottom-14 left-0 right-0 bg-primary/90 text-primary-foreground text-xs py-2.5 flex items-center justify-center gap-2 translate-y-full group-hover:translate-y-0 transition-transform duration-300"
