      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div>
          <div className="bg-secondary rounded-lg p-5 sticky top-24">
            ...
            <Link href="/checkout">
              <span
                className="block w-full bg-primary text-primary-foreground py-3 rounded-sm text-sm hover:bg-primary/90 transition-colors font-medium text-center cursor-pointer"
